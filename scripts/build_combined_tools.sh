...
./scripts/build_tool.sh "Combined Sprite Tools" "combined_sprite_tools.py" "Combined_Sprite_Tools" "--hidden-import=PIL --hidden-import=PIL.Image --hidden-import=PIL.ImageTk"
